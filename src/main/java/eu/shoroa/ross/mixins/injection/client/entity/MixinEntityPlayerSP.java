...
import eu.shoroa.ross.mixins.injection.entity.MixinEntityLivingBase;
...
public abstract class MixinEntityPlayerSP extends MixinEntityLivingBase {
    ...
    public void onUpdateWalkingPlayer() {
        ...
        EventMotion.Pre preMotionEvent = new EventMotion.Pre(player, this.posX, this.getEntityBoundingBox().minY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround, ((MinecraftAccessor) mc).getTimer().renderPartialTicks);
        ...
        if (this.isCurrentViewEntity()) {
            ...
            EventMotion.Post postMotionEvent = new EventMotion.Post(player, ((MinecraftAccessor) mc).getTimer().renderPartialTicks);
