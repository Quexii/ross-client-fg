...
import eu.shoroa.ross.loader.RossMod;
import eu.shoroa.ross.render.gl.uniform.*;
...
public final class Shader {
    ...
    public void init() throws IOException {
        ...
        int vid = createShader(vSrc, GL20.GL_VERTEX_SHADER);
        int fid = createShader(fSrc, GL20.GL_FRAGMENT_SHADER);
    ...
    private int createShader(String src, int type) throws IOException {
        ...
        GL20.glShaderSource(id, readStream(RossMod.class.getResourceAsStream("/assets/" + RossMod.MOD_ID + "/" + src)));
    ...
    public void rect(float x, float y, float w, float h) {
        vbo.data(new float[]{x, y, 0f, 1f, x, y + h, 0f, 0f, x + w, y + h, 1f, 0f, x + w, y, 1f, 1f});
