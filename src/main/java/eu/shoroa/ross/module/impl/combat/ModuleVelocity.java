...
public class ModuleVelocity extends Module {
    private final ModeSetting<Mode> modeSetting = register(new ModeSetting<>("Mode", "mode", Mode.PERCENT));
    private final NumberSetting horizontalPercent = register(new NumberSetting("Horizontal Percent", "horizontal_percent", 100, 0, 100, 1));
    private final NumberSetting verticalPercent = register(new NumberSetting("Vertical Percent", "vertical_percent", 100, 0, 100, 1));
